...
フロンドエンドの開発は年々新しい技術が取り込まれ、開発は複雑化していきモダンな開発を行うためにはフレームワークを駆使する必要が出来てきました。そのフレームワークの中でもAngularJS・Reactの人気を超えるVue.js。

今回はVue.jsをSSRするために登場したNuxt.jsについてハンズオンしていきます。
